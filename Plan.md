...
4. Вывод на экран сообщение: "Успешно. Операция одобрена Банком".

**2. Покупка тура с использованием карты со статусом DECLINED**
1. В поле "Номер карты" вести отклоненную карту "4444 4444 4444 4442".
2. Заполнить остальные поля корректными данными.
3. Нажать кнопку "Продолжить".
4. Вывод на экран сообщение: "Ошибка! Банк отказал в проведении операции."

**3. Покупка тура в кредит с использованием карты со статусом APPROVED**
1. В поле "Номер карты" вести одобренную карту "4444 4444 4444 4441".
2. Заполнить остальные поля корректными данными.
3. Нажать кнопку "Продолжить".
4. Вывод на экран сообщение: "Успешно. Операция одобрена Банком".

**4. Покупка тура в кредит с использованием карты со статусом DECLINED**
1.	В поле "Номер карты" вести отклоненную карту "4444 4444 4444 4442".
2. Заполнить остальные поля корректными данными.
3. Нажать кнопку "Продолжить".
4. Вывод на экран сообщение: "Ошибка! Банк отказал в проведении операции."
...
- Тестирование поля "Месяц".
    - В поле "Месяц" ввести значение "01" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные.
    - В поле "Месяц" ввести значение "12" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные. 
- Тестирование поля "Год".
    - В поле "Год" ввести значение "23" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные.
    - В поле "Год" ввести значение "27" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные. 
- Тестирование поля "Владелец".
    - В поле "Владелец" ввести значение на латинице в кол-ве 64 символов / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные.
    - В поле "Владелец" ввести значение на латинице в кол-ве 3 символов / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные.
    - В поле "Владелец" ввести значение на латинице с использованием дефиса / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные.
- Тестирование поля "CVC/CVV".
    - В поле "CVC/CVV" ввести значение "001" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные.
    - В поле "CVC/CVV" ввести значение "999" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Успешно. Операция одобрена Банком" / В БД успешно записаны данные.
...
- Тестирование поля "Номер карты".
    - Поле "Номер карты" оставить пустым / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "Номер карты" выводится сообщение: "Неверный формат" / В БД данные не записаны.
    ...
    - В поле "Номер карты" ввести невалидный номер карты / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Вывод на экран сообщение: "Ошибка! Банк отказал в проведении операции." / В БД успешно записаны данные.

- Тестирование поля "Месяц".
    - Поле "Месяц" оставить пустым / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "Месяц" выводится сообщение: "Неверный формат" / В БД данные не записаны.
...
- Тестирование поля "Год".
    - Поле "Год" оставить пустым / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "Год" выводится сообщение: "Неверный формат" / В БД данные не записаны.
    - В поле "Год" ввести значение "22" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "Год" выводится сообщение: "Истек срок действия карты" / В БД данные не записаны.
    - В поле "Год" ввести значение "28" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "Год" выводится сообщение: "Неверно указан срок действия карты" / В БД данные не записаны.
...
- Тестирование поля "Владелец".
    ...
    - В поле "Владелец" ввести значение на кириллице "Иван Иванов" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "Владелец" выводится сообщение: "Неверный формат имени владельца" / В БД данные не записаны.
    - В поле "Владелец" ввести цифровое значение "23458 235" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "Владелец" выводится сообщение: "Неверный формат имени владельца" / В БД данные не записаны.
    - В поле "Владелец" ввести спецсимволы ":%№;( :?;" / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "Владелец" выводится сообщение: "Неверный формат имени владельца" / В БД данные не записаны.

- Тестирование поля "CVC/CVV". 
    - Поле "CVC/CVV" оставить пустым / Заполнить остальные поля валидными данными / Нажать кнопку "Продолжить" / **Результат:** Под полем "CVC/CVV" выводится сообщение: "Неверный формат" / В БД данные не записаны.
